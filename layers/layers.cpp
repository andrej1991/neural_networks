...
inline int Layer::get_threadcount()
    {throw runtime_error("Unimplemented function: Layer::get_threadcount()\n");}

void Layer::create_connections(vector<int> input_from, vector<int> output_to)
    {throw runtime_error("Unimplemented function: Layer::input_from\n");}
...
int Layer::get_horizontal_stride()
    {throw runtime_error("Unimplemented function: Layer::get_horizontal_stride\n");}
