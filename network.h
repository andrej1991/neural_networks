...
class Network{
    int total_layers_num, layers_num, costfunction_type, inputpixel_count, input_feature_depth;
    Layer **layers;
    bool dropout;
    ...
    Network(int layers_num, LayerDescriptor **layerdesc, int inputpixel_count, int input_feature_depth = 1, int costfunction_type = CROSS_ENTROPY_CF, bool dropout = false);
    ~Network();
